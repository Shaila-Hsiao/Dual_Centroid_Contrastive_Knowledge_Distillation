...
# StudentResNet50 with customizable block counts
class StudentResNet50(nn.Module):
    def __init__(self, block_counts, num_classes=1000):
        super(StudentResNet50, self).__init__()
        norm_layer = nn.BatchNorm2d
        self.inplanes = 64
        self.dilation = 1
        block = Bottleneck
...
# 加在這裡！
def student_resnet50(block_counts):
    def _create(num_classes=1000):
        return StudentResNet50(block_counts=block_counts, num_classes=num_classes)
    return _create